<?php
$page_title = "Dosen - Universitas Pamulang ";
...
// Query untuk mengambil nama dosen berdasarkan NIDN
$query = "SELECT nama_dosen FROM dosen WHERE nidn = '$nidn_login'";
$result = mysqli_query($connection, $query);
if ($result && mysqli_num_rows($result) > 0) {
    $row = mysqli_fetch_assoc($result);
    // Menyimpan nama dosen ke session
