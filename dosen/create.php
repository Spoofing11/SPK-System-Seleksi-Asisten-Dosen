        ...
        <div class="card-body">
          ...
          <form action="./store.php" method="POST">
            <table cellpadding="8" class="w-100">
              ...
              <tr>
                <td>Fakultas</td>
                <td colspan="3"><input class="form-control" type="text" name="fakultas" size="20" required></td>
              </tr>
              
              <tr>
                <td>Program Studi</td>
                <td colspan="3"><input class="form-control" type="text" name="program_studi" size="20" required></td>
              </tr>
              
              <tr>
                <td>Gmail</td>
                <td colspan="3"><input class="form-control" type="email" name="gmail" size="20" required></td>
              <tr>
                <td>
